...
public class RedisUtils {
    ...
    public Set zsRange(String key, long start, long end) {
        try {
            Set zSet = redisTemplate.opsForZSet().range(key, start, end);
            return zSet;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    public Set zsRangeByScore(String key, double min, double max) {
        try {
            Set zSet = redisTemplate.opsForZSet().rangeByScore(key, min, max);
            return zSet;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
