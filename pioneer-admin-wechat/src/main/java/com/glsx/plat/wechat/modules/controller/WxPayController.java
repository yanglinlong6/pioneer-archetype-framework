...
@RequestMapping("/pay")
@AllArgsConstructor
public abstract class WxPayController {
    ...
    public R<WxPayUnifiedOrderResult> unifiedOrder(@RequestBody WxPayUnifiedOrderRequest request) throws WxPayException {
        String outTradeNo = "B" + SnowFlake.nextSerialNumber();
        request.setOutTradeNo(outTradeNo);
        WxPayUnifiedOrderResult orderResult = this.wxPayService.unifiedOrder(request);
        Map<String, Object> rtnMap = unifiedOrder(orderResult);
     ...
     * @param result
     */
    protected abstract Map<String, Object> unifiedOrder(WxPayUnifiedOrderResult result);
